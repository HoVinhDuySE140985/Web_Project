 ...
 * @author くろくん
 */
@WebServlet(name = "AddCart_Controller", urlPatterns = {"/AddCart_Controller"})
public class AddCart_Controller extends HttpServlet {
        private static final String FAIL = "error.jsp";
        private static final String SUCCESS = "shopping_user.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(cart==null){
                cart = new Cart_DAO();// neu chua cop cart thi lay gio hang 
            }
            String id =request.getParameter("proID");
            Product_DTO dto = dao.getproID(id);
            ProductCart proCart = new ProductCart(dto);
            cart.addToCart(proCart);
